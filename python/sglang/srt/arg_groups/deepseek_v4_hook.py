...
def apply_deepseek_v4_defaults(server_args: ServerArgs, model_arch: str) -> None:
    ...
    # KTransformers: pin the speculative MoE runner backend to the resolved
    # target one (arg_groups/overrides.py: _deepseek_v4_sm120_moe), invoked
    # here at its legacy slot.
